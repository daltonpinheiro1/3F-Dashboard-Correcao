...
[[ -f supabase/migrations/027_portabilidade_cohort_universo.sql ]] || fail "migration 027 ausente"
...
"$RG" -q "meta_mes" functions/api/portabilidade-funil.ts || fail "funil deve expor meta_mes"
